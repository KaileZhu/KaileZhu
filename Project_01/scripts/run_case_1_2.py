...
if __name__ == '__main__':
    ...
    path_file = f'{path}/scenes/scene_01.yaml'
    ...
    subtasks.extend([(i, matches[i][0], matches[i][1]) 
                    for i in range(len(matches))])

    #=========================
    # Calculation process
    #=========================
    buchi.gener_poset_by_anytime(10)
    print(buchi.poset.poset_list)
    
    solver = Branch_And_Bound(buchi.poset.poset_list[0], subtasks, scene)
    solver.Begin_branch_search2(5, up_bound_method='greedy', 
